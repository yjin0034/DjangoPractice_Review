...
urlpatterns = [
    # index 페이지 URL 매핑
    # pybo/ 로 시작하는 페이지를 요청하면, (pybo/views의) views.index 함수를 호출하도록 함
    ...
    # 질문 상세 페이지 URL 매핑
    # pybo/[정수형 숫자]로 시작하는 페이지를 요청하면, 해당 정수형 숫자를 question_id에 저장하고, views.detail 함수를 호출
    ...
    # 답변 등록 기능 URL 매핑
    # pybo/answer/create/[정수형 숫자]로 시작하는 페이지를 요청하면, 해당 정수형 숫자를 question_id에 저장하고, views.answer_create 함수를 호출
    path('answer/create/<int:question_id>/', views.answer_create, name='answer_create'),

    # 질문 등록 기능 URL 매핑
    # pybo/question/create로 시작하는 페이지를 요청하면, views.question_create 함수를 호출
